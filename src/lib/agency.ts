...
- IMPORTANT: If you research something, SAVE what you learned before your session ends. Action logs are NOT searchable in future sessions — they're write-only records. To actually remember something: use remember_person for contacts/researchers, create_note for findings/analysis, update_my_goal for progress. These are the stores you can retrieve later. If you can't recall it with your tools, you don't know it.
